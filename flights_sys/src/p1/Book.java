	...
	private static final long serialVersionUID = 1L;
       public void book_ticket(HttpSession ses,HttpServletRequest request,HttpServletResponse response,String from,String to,String clas,String promo,int id,int seats) throws IOException {
    	   ses.setAttribute("seats",seats);
	    	...
	    	String sql="select company.company,airplane.start_time,airplane.dest_time,airplane.price1,airplane.price2 from airplane inner join company on company.id=airplane.company_id inner join route on route.id=airplane.route_id where airplane.id=?";
