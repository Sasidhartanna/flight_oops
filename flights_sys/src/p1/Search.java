...
public class Search extends HttpServlet {
	...
	public ArrayList<Airplane> search_flights(String type,String from,String to,String date,String clas,HttpServletRequest request) {
		...
		String sql="select airplane.id,company.company,route.distance,airplane.start_time,airplane.dest_time,airplane.mon_seats,airplane.mon_seats_bus,airplane.price1,airplane.price2 from airplane inner join company on company.id=airplane.company_id inner join route on route.id=airplane.route_id where route.from1=? and route.to1=? and mon=1";
		if(x.equals("mon"))
		 sql="select  airplane.id,company.company,route.distance,airplane.start_time,airplane.dest_time,airplane.mon_seats,airplane.mon_seats_eco,airplane.price1,airplane.price2 from airplane inner join company on company.id=airplane.company_id inner join route on route.id=airplane.route_id where route.from1=? and route.to1=? and mon=1";
		if(x.equals("tue"))
			sql="select  airplane.id,company.company,route.distance,airplane.start_time,airplane.dest_time,airplane.tue_seats,airplane.tue_seats_bus,airplane.price1,airplane.price2 from airplane inner join company on company.id=airplane.company_id inner join route on route.id=airplane.route_id where route.from1=? and route.to1=? and tue=1";
		if(x.equals("wed"))
			sql="select  airplane.id,company.company,route.distance,airplane.start_time,airplane.dest_time,airplane.wed_seats,airplane.wed_seats_bus,airplane.price1,airplane.price2 from airplane inner join company on company.id=airplane.company_id inner join route on route.id=airplane.route_id where route.from1=? and route.to1=? and wed=1";
		if(x.equals("thu"))
			sql="select  airplane.id,company.company,route.distance,airplane.start_time,airplane.dest_time,airplane.thu_seats,airplane.thu_seats_bus,airplane.price1,airplane.price2 from airplane inner join company on company.id=airplane.company_id inner join route on route.id=airplane.route_id where route.from1=? and route.to1=? and thu=1";
		if(x.equals("fri"))
			sql="select  airplane.id,company.company,route.distance,airplane.start_time,airplane.dest_time,airplane.fri_seats,airplane.fri_seats_bus,airplane.price1,airplane.price2 from airplane inner join company on company.id=airplane.company_id inner join route on route.id=airplane.route_id where route.from1=? and route.to1=? and fri=1";
		if(x.equals("sat"))
			sql="select  airplane.id,company.company,route.distance,airplane.start_time,airplane.dest_time,airplane.sat_seats,airplane.sat_seats_bus,airplane.price1,airplane.price2 from airplane inner join company on company.id=airplane.company_id inner join route on route.id=airplane.route_id where route.from1=? and route.to1=? and sat=1";
		if(x.equals("sun"))
			sql="select  airplane.id,company.company,route.distance,airplane.start_time,airplane.dest_time,airplane.sun_seats,airplane.sun_seats_bus,airplane.price1,airplane.price2 from airplane inner join company on company.id=airplane.company_id inner join route on route.id=airplane.route_id where route.from1=? and route.to1=? and sun=1";
		    	    	
		String url="jdbc:mysql://localhost:3306/flight?useSSL=false";
    	String root="root";
    	String password="Sasidhar@29";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	HttpSession ses=request.getSession();
    			...
    			if(a.size()==0) {
    	    			out.print("<html><script>alert('No flights available on this date')</script>");
    	    			out.print("<script>location.href='index.jsp'</script></html>");
    	    		}
    	    		else {
