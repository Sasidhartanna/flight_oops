...
<div id="two" style="display:none">
  ...
  Class.forName("com.mysql.jdbc.Driver");
	 ...
	 Statement st=con.createStatement();
	//st.setString(1, x);
	String  sql1="select airplane.id,company.company,route.from,route.to,airplane.start_time,airplane.dest_time from flight.airplane inner join flight.route on airplane.route_id=route.id inner join company on airplane.company_id=company.id";
	 ResultSet rs=st.executeQuery(sql1);
	while(rs.next()){%>
