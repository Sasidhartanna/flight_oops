  ...
  try{
	  ...
	  String password="Sasidhar@29";
	 	...
	 	Connection con=DriverManager.getConnection(url, root, password);
	 	 Statement st=con.createStatement();
	  	String sql1="select route.id,route.from1,route.to1 from flight.route ";
	  	ResultSet rs=st.executeQuery(sql1);
		while(rs.next())
		{
		%>
...
<div id="two" style="display:none">
  ...
  Class.forName("com.mysql.jdbc.Driver");
	 ...
	 Statement st=con.createStatement();
	//st.setString(1, x);
	String  sql1="select airplane.id,company.company,route.from1,route.to1,airplane.start_time,airplane.dest_time from flight.airplane inner join flight.route on airplane.route_id=route.id inner join company on airplane.company_id=company.id";
	 ResultSet rs=st.executeQuery(sql1);
	while(rs.next()){%>
...
<div id="five" style="display:none">
	<form action="Admin" method="post">
			...
			<tr><td>Enter From:</td><td><input type="text" name="from1"></td></tr>
			<tr><td>Enter To:</td><td><input type="text" name="to1"></td></tr>
			</table>
