...
<div class="page">
  ...
  Class.forName("com.mysql.jdbc.Driver");
	...
	String sql1="select international.place from flight.international where domestic=1 or international=1";
...
<b style='color:red'>
<h3>
Advanced Bookings can be made for only one week from current date
</h3>
</b></marquee>
